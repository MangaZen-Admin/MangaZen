...
INSERT INTO "new_User" ("createdAt", "email", "emailVerified", "externalDonationLink", "hideFavoritesFromPublic", "hideFromRankings", "hideReadingStatsFromPublic", "hideZenFromPublic", "id", "image", "isPro", "isProfilePublic", "lastDailyLoginAt", "name", "passwordHash", "proExpiresAt", "requireEmailCodeForPoints", "requirePasswordForPoints", "role", "updatedAt", "username", "zenCoins", "zenPoints", "zenShards") SELECT "createdAt", "email", "emailVerified", "externalDonationLink", "hideFavoritesFromPublic", "hideFromRankings", "hideReadingStatsFromPublic", "hideZenFromPublic", "id", "image", "isPro", "isProfilePublic", "lastDailyLoginAt", "name", "passwordHash", "proExpiresAt", "requireEmailCodeForPoints", "requirePasswordForPoints", "role", "updatedAt", "username", "zenCoins", "zenPoints", "zenShards" FROM "User";
DROP TABLE "User";
