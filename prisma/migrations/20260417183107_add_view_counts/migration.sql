...
INSERT INTO "new_Chapter" ("createdAt", "earlyAccessPrice", "earlyAccessUntil", "id", "isEarlyAccess", "language", "locale", "mangaId", "number", "startsWithSinglePage", "status", "title", "updatedAt") SELECT "createdAt", "earlyAccessPrice", "earlyAccessUntil", "id", "isEarlyAccess", "language", "locale", "mangaId", "number", "startsWithSinglePage", "status", "title", "updatedAt" FROM "Chapter";
DROP TABLE "Chapter";
...
INSERT INTO "new_Manga" ("alternativeTitle", "artist", "author", "bannerImage", "boostExpiresAt", "contentRating", "coverImage", "createdAt", "demographic", "description", "id", "isAmateur", "isFeatured", "isWebcomic", "isYonkoma", "reviewRejectionReason", "reviewStatus", "scoreAvg", "scoreCount", "slug", "status", "title", "type", "updatedAt", "uploaderId") SELECT "alternativeTitle", "artist", "author", "bannerImage", "boostExpiresAt", "contentRating", "coverImage", "createdAt", "demographic", "description", "id", "isAmateur", "isFeatured", "isWebcomic", "isYonkoma", "reviewRejectionReason", "reviewStatus", "scoreAvg", "scoreCount", "slug", "status", "title", "type", "updatedAt", "uploaderId" FROM "Manga";
DROP TABLE "Manga";
