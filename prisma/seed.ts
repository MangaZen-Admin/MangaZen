    ...
    data: [
      {
        ...
        isActive: true,
        scripts: ["<!-- AdSense HOME_HERO placeholder -->"],
      },
      {
        slotId: "HOME_MID",
        label: "Banner entre secciones homepage",
        isActive: true,
        scripts: ["<!-- AdSense HOME_MID placeholder -->"],
      },
      {
        slotId: "LIBRARY_GRID",
      ...
      },
      {
        ...
        isActive: true,
        scripts: ["<!-- AdSense MANGA_HUB placeholder -->"],
      },
      {
        slotId: "READER_END",
        label: "Al final del capítulo (post-lectura)",
        isActive: true,
        scripts: ["<!-- AdSense READER_END placeholder -->"],
      },
    ],
  });
